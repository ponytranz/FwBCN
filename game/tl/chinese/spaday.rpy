...
translate chinese spaday_d373c19f:
    ...
    moxie "嘿，Butters，准备好了吗？"

# game/spaday.rpy#L23
translate chinese spaday_420aea9c:

    # butters "I certainly am!"
    butters "当然了！"

# game/spaday.rpy#L25
translate chinese spaday_0d04dd87:

    # butters "It would seem you’re the only male on this trip, [playername]. I wonder if the sauna will be unisex?"
    butters "[playername]，你可是这里唯一的一个男生。我在想，桑拿房会不会是男女混用的呢？"
...
# game/spaday.rpy#L33
translate chinese spaday_6ff437cd:

    # butters "Nooo, I was joking! Hehe."
    butters "不不不，我刚才是在开玩笑呢！哈哈……"

# game/spaday.rpy#L34
translate chinese spaday_68916342:

    # mc "Hmm, were you really though?"
    mc "嗯，你不会真有过吧？"

# game/spaday.rpy#L41
translate chinese spaday_9e1e3cc1:

    # riku "Oh please, get your head out of the clouds. Is bedding every god damn single one of us not enough for you?"
    riku "哦，拜托，请你别再胡思乱想了。难道对你来说，和咱们中的每个人上一遍床还满足不了你吗？"

# game/spaday.rpy#L47
translate chinese spaday_702fe0ce:

    # cream "Who better to do so, though?"
    cream "可还有谁是干这事的最佳人选呢？"

# game/spaday.rpy#L53
translate chinese spaday_d2e8e053:

    # honeycrisp "And it’s not like any of us stopped, even after we found out…"
    honeycrisp "我们并没有一个人停下来，即使我们发现了…"

# game/spaday.rpy#L63
translate chinese spaday_e8cd62c3:

    # lily "I guess [playername] just has an irresistible charm to him, wouldn’t you say, ladies?"
    lily "我猜，[playername]对他有一种难以抗拒的吸引力，你们说呢，姑娘们？"

# game/spaday.rpy#L69
translate chinese spaday_dc379c12:

    # penelope "Hmm… You think it’s one of Morrigan’s spells lingering on him?"
    penelope "嗯……你觉得这是Morrigan给他施的咒语吗？"

# game/spaday.rpy#L75
translate chinese spaday_b17752f7:

    # ruby "[playername] needs no spell to win {i}me{/i} over."
    ruby "[playername]不需要使用咒语来赢{i}我{/i}。"
...
translate chinese spaday_40693c67:
    ...
    moxie "嗯……好吧，[playername]，恭喜你了。虽然我不知道你是怎么做到的，但你已经赢得了让屋子里八个姑娘同时为你神魂颠倒和调戏勾引你的机会！"

# game/spaday.rpy#L92
translate chinese spaday_860bbfb7:

    # riku "Ahaha, is that jealousy I detect, Moxie?"
    riku "啊哈，Moxie，你是不是很嫉妒啊？"

# game/spaday.rpy#L94
translate chinese spaday_0a432549:

    # moxie "N-n-n-n-no!"
    moxie "不不不，才没呢！"

# game/spaday.rpy#L100
translate chinese spaday_3c32475c:

    # cream "I bet you’ve fucked him more than any of us anyway!"
    cream "我敢说，你和她啪啪啪的次数肯定比我们当中任何一个都多！"

# game/spaday.rpy#L102
translate chinese spaday_7386c6b2:

    # moxie "Bwah, why can’t I have normal friends that gossip about the latest TV shows?"
    moxie "呃，为什么就没有一个能聊聊热播电视节目的正常朋友呢？"

# game/spaday.rpy#L103
translate chinese spaday_13210f8f:

    # mc "Awhh, poor Moxie... Although I feel like I should be the one getting flustered here."
    mc "哦，可怜的Moxie……我感觉自己才应该是那个感到不安的人才对。"

# game/spaday.rpy#L105
translate chinese spaday_6c7c4ccc:

    # riku "Hah, I bet you're used to this treatment by now!"
    riku "哈，我敢打赌，你现在肯定已经习惯这种待遇了！"

# game/spaday.rpy#L107
translate chinese spaday_ec7eccfa:

    # cream "We gotta cherish our times together, you never know whether or not this time will be the last..."
    cream "我们要珍惜在一起的时光，因为你永远都不知道相处的时间能持续多久……"

# game/spaday.rpy#L109
translate chinese spaday_14147c3b:

    # moxie "Hmm, that's a little sombre."
    moxie "嗯，这感觉有点悲伤啊。"

# game/spaday.rpy#L111
translate chinese spaday_8e28a749:

    # cream "Nooo, you're supposed to be happy! Because if it is the last time, you need to enjoy it as much as you possibly can."
    cream "不会吧，你应该高兴才对啊！因为如果这是最后一次相处机会的话，你应该尽可能地去享受才对啊。"

# game/spaday.rpy#L119
translate chinese spaday_11c3d7f4:

    # ruby "Hey, speaking of television, did anyone watch the ending to The Deep? The season finale was a few days ago."
    ruby "嘿，说到电视节目，有谁看过The Deep的大结局了？这季的大结局几天前就已经播过了。"

# game/spaday.rpy#L127
translate chinese spaday_8a341459:

    # lily "Yesss! It was so awesome!"
    lily "是啊！大结局太精彩了！"

# game/spaday.rpy#L129
translate chinese spaday_e5083aca:

    # "The eight of us chatter back and forth about anything and nothing as we go from the castle to the sauna."
    "在从城堡到桑拿房的路上，我们八个人一直都在聊着闲天。"

# game/spaday.rpy#L130
translate chinese spaday_3f0801c8:

    # "And here we are…"
    "然后，我们就到了……"

# game/spaday.rpy#L132
translate chinese spaday_98f9d9bb:
    ...
    "我在其他人都走进桑拿房后才走了进去。在我还没有进到温度舒适的水中时，所有人都在向我打着招呼。"

# game/spaday.rpy#L133
...
# game/spaday.rpy#L135
translate chinese spaday_58ead9de:

    # "A world where I can pave my own future, and more importantly, have fun with the friends on that journey."
    "我可以在这个世界成就自己的未来，而且最重要的是，在此过程中，我还能和我的朋友们一起享受快乐。"

# game/spaday.rpy#L136
translate chinese spaday_3272f51f:

    # "I’m so grateful to Penelope, who saw reason and defied her upbringing and Queen to help save Arcadia."
    "我十分感激Penelope，她不但明事理，而且为了拯救Arcadia，她还敢违抗自己的家族和女王的命令。"

# game/spaday.rpy#L137
...
translate chinese spaday_57d0ba80:
    ...
    "我十分迷恋Honeycrisp，她是个坚强、值得信赖的朋友兼情人。她四处宣扬美德，而且每天都在身体力行。能得到这样一个朋友的支持，所有的困难都可以被克服。"

# game/spaday.rpy#L139
translate chinese spaday_e946c029:
    ...
    "对于Riku，我该从何说起呢？在经历过很多事情之后，她就变成了我所见过的最坚强的人。不论是从生理还是心理上说，她都是最坚强的！"

# game/spaday.rpy#L140
translate chinese spaday_bb625a75:
    ...
    "但她还是很平和，很亲切。而且，她是目前为止所有人中最有亲和力，也最热情的一个。我也经常会去找她，并且把她看作是自己最亲密的好朋友之一。"

# game/spaday.rpy#L141
...
translate chinese spaday_4cb79f4b:
    ...
    "不仅如此，她还在采取实际措施来消除自己的弱点，并成为一名适合领导Arcadia的统治者。"

# game/spaday.rpy#L143
translate chinese spaday_233bec1b:
    ...
    "Butters在我人生的每一步都是我挚爱的朋友。很幸运的是，她出事的时候我在场，我们一起设法平息了她变成怪物的危险。"

# game/spaday.rpy#L144
translate chinese spaday_671a4c5a:
    ...
    "她一直违抗有危险的天性，她坚持作为一个充满爱和友好的生物生活，只寻求帮助尽可能多的生物。"

# game/spaday.rpy#L145
translate chinese spaday_f1b25a1a:

    # "And indeed, she did, as she was the link that saved all of Arcadia in her vast knowledge, and good fortune!"
    "事实上，她做到了，因为她是拯救Arcadia所有生物的纽带，她拥有广博的知识和好运！"

# game/spaday.rpy#L146
translate chinese spaday_c9f133aa:
    ...
    "我忘不了Cream，一个烤面包的女孩，如同她的个性一样美味。在这个女孩的陪伴下，每一个逝去的瞬间都是令人难忘的，充满了欢乐和兴奋。"

# game/spaday.rpy#L147
...
translate chinese spaday_c1c58bda:
    ...
    "她总是努力提升自己，学习更多知识。她曾在篷车里告诉我说，他的愿望是让世界变得更美好。"

# game/spaday.rpy#L152
...
translate chinese spaday_ce85d8aa:
    ...
    "我认为这是正当的，因为我自己正在了解世界，但我认为是时候开始做一些重大决定了。"
...
# game/spaday.rpy#L162
translate chinese spaday_a71ddd98:

    # "That’s a good choice indeed…"
    "这确实是个好主意……"

# game/spaday.rpy#L163
